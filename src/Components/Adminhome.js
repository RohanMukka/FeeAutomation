...
class Adminhome extends React.Component {
  ...
  componentDidMount() {
    ...
    Axios.get(`${process.env.REACT_APP_API_BASE_URL}/admin`, config)
      .then((res) => {
        this.setState({
  ...
  submitSearch() {
    ...
    Axios.get(`${process.env.REACT_APP_API_BASE_URL}/admin/search`, config)
      .then((res) => {
        this.setState({
          students: res.data,
          isValid: 1
      ...
      buttons: [
        {
          ...
          onClick: () => {
            ...
            Axios.post(`${process.env.REACT_APP_API_BASE_URL}/admin/resetStudentPassword`, {admno: target.id}, config)
            .then(res => {this.submitSearch();})
      ...
      buttons: [
        {
          ...
          onClick: () => {
            ...
            Axios.post(`${process.env.REACT_APP_API_BASE_URL}/admin/markPaid`, { admno: target.id }, config)
              .then(res => { this.submitSearch(); })
              .catch(err => {/* handle error if needed */});
          }
        },
          ...
          <div className={Style.leftcolumn}>
            <div className={Style.card}>
              ...
              <select name="scholname" onChange={this.handleChange}>
                ...
                <option value="E-Grantz">EPass</option> <option value="Merit">Merit</option>
              </select>
